...
See docs/architecture/PERSONA_FORGE_STUDIO.md §1. OmniVoice reuses the same one-model-at-a-time
...
# docs/archive/omnivoice/omnivoice_integration.md and the 2026-07-03 upstream-docs review. Clamped
